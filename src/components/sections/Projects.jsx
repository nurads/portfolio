...
const projects = [
  {
    title: "Gumisofts.com",
    description: "",
    image: "/projects/gumisofts.com.png",
    technologies: ["NextJs", "Postgress", "Django"],
    liveLink: "https://gumisofts.com",
    githubLink: "https://github.com/nurads/gumisofts_website",
    features: ["Elegant Design", "Blog", "Application Tracker"],
  },
  {
    title: "Temarico.com",
    description:
      "A comprehensive web platform for managing and optimizing business operations, featuring real-time analytics, automated workflows, and seamless integration capabilities.",
  ...
  },
  {
    ...
    description:
      "A powerful mobile application that extends Temarico's capabilities to iOS and Android devices, enabling on-the-go business management and real-time collaboration.",
  ...
  },
  {
    title: "Azcare.ai",
    description:
      "An innovative healthcare platform leveraging artificial intelligence to provide personalized patient care, predictive analytics, and automated healthcare management solutions.",
  ...
  },
  {
    ...
    description:
      "A comprehensive tourism and travel management platform for Ethiopia's premier tour operator. Features include tour package management, booking system, and a beautiful showcase of Ethiopia's diverse tourist destinations including historical sites, wildlife safaris, and cultural experiences.",
  ...
  },
  {
    title: "Adero.tech",
    description:
      "An innovative enterprise software platform that streamlines business operations through advanced automation, real-time analytics, and seamless integration capabilities. Built with modern technologies to deliver scalable and efficient solutions for complex business needs.",
    ...
    githubLink: null,
    features: ["Responsive Design", "Content Management System"],
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              ...
              full-stack development, mobile applications, and AI integration.
            </p>
          </div>
